    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('_quantite', models.FloatField()),
                ('_idArticle', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Sprint1.Article')),
                ('_idIngrediant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Sprint1.Ingredient')),
            ],
        ),
        migrations.AddField(
            model_name='article',
